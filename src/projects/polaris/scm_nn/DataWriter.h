...
class DataWriterVehicle : public DataWriter {
  public:
    DataWriterVehicle(chrono::ChSystem* sysFSI, std::shared_ptr<chrono::vehicle::WheeledVehicle> vehicle, chrono::vehicle::SCMTerrain& terrain);
    ~DataWriterVehicle() {}
  ...
  //   virtual chrono::ChFrame<> GetSampleBoxFrame(int box_id) const override;
    ...
    chrono::vehicle::SCMTerrain& m_terrain;
